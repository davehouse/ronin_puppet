...
class roles_profiles::roles::gecko_t_osx_1100 {

    #include ::roles_profiles::profiles::timezone
    include ::roles_profiles::profiles::ntp
    # include ::roles_profiles::profiles::network  # disables wifi and bonjour
    ...
    include ::roles_profiles::profiles::gecko_t_osx_1100_generic_worker
